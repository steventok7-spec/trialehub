    ...
    <div class="bg-white rounded-3xl shadow-sm border border-zinc-100 overflow-hidden min-h-[50vh]">
      @if (loading()) {
        <div class="flex flex-col items-center justify-center h-full py-32">
          ...
          <p class="text-zinc-500 font-medium">Loading leave requests...</p>
        </div>
        ...
        <div class="p-6 space-y-4">
          <div class="flex items-center justify-between mb-6">
            <h3 class="font-bold text-lg text-zinc-900">Leave Requests</h3>
...
export class AdminLeave implements OnInit {
  ...
  loadRequests() {
    ...
    this.api.getRequests('leave').subscribe({
      next: (data) => {
